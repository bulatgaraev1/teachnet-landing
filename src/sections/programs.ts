...
const STEPS = [
  ...
  // вернуть, когда запустим Spike (и перенумеровать ступени, раскладку — на 4 в ряд)
  // {
  //   n: '2',
  ...
  {
    n: '2',
    tag: 'СТУПЕНЬ 2 · от 10 лет',
    title: 'Электроника',
    text: 'Реальные компоненты: платы, микроконтроллеры, датчики. Ребёнок сам рассчитывает схемы и пишет для них программы.',
    meta: '90 минут · группа до 6 человек',
    // ссылка «Подробнее о курсе →» пока скрыта; чтобы вернуть, раскомментировать:
    // href: '/electronics',
    // goal: 'programs_electronics',
  },
  {
    n: '3',
    tag: 'СТУПЕНЬ 3 · от 14 лет',
